...
def auc_calculation(scorefile, labels, chunks, rpar, npar):
    ...
    for i in range(0,len(co_val)):       #iterate over cut off value list
        ...
        specificity.append(len(df_ts.loc[df_ts['labels']==1])) #append the # of values that is lower than cutoff value and is normal
...
#%%
#generate data: 
chunks = chunk("C:/Users/yanas/OneDrive/Masters/Untitled Folder 1/NatCom2022/week4/negative-selection/syscalls/snd-cert/snd-cert.2.test", 7, "snd-cert-2-pp.test")
#%%
#generate auc value 
auc_calculation("C:/Users/yanas/OneDrive/Masters/Untitled Folder 1/NatCom2022/week4/negative-selection/snd-cert-2-scores-3.csv", 
"C:/Users/yanas/OneDrive/Masters/Untitled Folder 1/NatCom2022/week4/negative-selection/syscalls/snd-cert/snd-cert.2.labels", 
chunks, 
5, 
7)
# r = 3 0.48 
